class ApplicationController < ActionController::Base
  ...
  # the next methods are seen from all controllers but not from the views
  # we need to tell rails the name of the methods we want to be seen from the views
  # declaring them as helper methods
